...
// =============================================================================
// MOBILE HERO - Mobile-Optimized Video Background
// Same design as DesktopHero but with mobile-optimized video
// =============================================================================

export const MobilHero = () => {
    ...
    return (
        <section
            ...
            style={{ zIndex: 1 }}
        >
            {/* Video Background - Mobile version */}
            <video
                ref={videoRef}
                className="absolute inset-0 w-full h-full object-cover"
                src="/video-mobil/Mobil-1.mp4"
                autoPlay
                muted
                playsInline
                preload="metadata"
